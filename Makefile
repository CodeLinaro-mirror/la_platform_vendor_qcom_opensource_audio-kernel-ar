...
ifeq ($(TARGET_SUPPORT), $(filter $(TARGET_SUPPORT), sdxpinn sdxpinn-cpe-wkk sdxbaagha sdxbaagha-nbntn sdxpinn-cpe-wkk-v1))
...
ifeq ($(TARGET_SUPPORT), $(filter $(TARGET_SUPPORT), sdxbaagha sdxbaagha-nbntn))
