...
/* swr-dmic   ADC Mux Sel
 *  0           0           MSM DMIC
 *  0           1           SWR AMIC
 *  1           0           INVALID
 *  1           1           SWR DMIC
 */
 /* This function checks if the decimator is fed from SWR MIC or VA MIC (DMIC) */
static bool is_msm_dmic_enabled(struct snd_soc_component *component, int decimator)
{
	...
	/* ADC_MUX_SEL is VA_MIC and swr_dmic_enable is 0, then dec is for msm-dmic use-case */
	...
	for_each_set_bit(decimator, &tx_priv->active_ch_mask[dai_id],
		...
		if (tx_priv->swr_dmic_gain_disable) {
			dec_gain_reg = LPASS_CDC_TX0_TX_PATH_CFG1 +
				LPASS_CDC_TX_MACRO_TX_PATH_OFFSET * decimator;
			snd_soc_component_update_bits(component, dec_gain_reg, 0x01, 0x00);
		}
	}
}
...
static int lpass_cdc_tx_macro_get_dec_gain_bypass(struct snd_kcontrol *kcontrol,
				struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component =
			snd_soc_kcontrol_component(kcontrol);
	...
	ucontrol->value.integer.value[0] = tx_priv->swr_dmic_gain_disable;

	return 0;
}

static int lpass_cdc_tx_macro_put_dec_gain_bypass(struct snd_kcontrol *kcontrol,
			    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component =
			snd_soc_kcontrol_component(kcontrol);
	...
	tx_priv->swr_dmic_gain_disable = value;
			       ...
			       struct snd_kcontrol *kcontrol, int event)
{
	...
	u16 tx_fs_reg = 0;
	u8 hpf_cut_off_freq = 0, swr_micn = 0;
	u16 adc_mux_reg = 0;
	u16 adc_mux0_reg = 0;
	u16 dmic_clk_reg = 0;
	...
	case SND_SOC_DAPM_PRE_PMD:
		...
		if (tx_priv->swr_dmic_gain_disable)
			snd_soc_component_update_bits(component, dec_gain_reg,
					0x01, 0x01);
...
static int lpass_cdc_tx_mute_stream(struct snd_soc_dai *dai, int mute, int stream)
{
	u32 decimator = 0;
	struct snd_soc_component *component = dai->component;
	struct lpass_cdc_tx_macro_priv *tx_priv = NULL;
...
static struct snd_soc_dai_ops lpass_cdc_tx_macro_dai_ops = {
	...
	.mute_stream = lpass_cdc_tx_mute_stream,
};
...
LPASS_CDC_TX_MACRO_DAPM_ENUM(tx_wsa_mux0, LPASS_CDC_TX_INP_MUX_ADC_MUX0_CFG1,
		   4, tx_wsa_mux_text);
LPASS_CDC_TX_MACRO_DAPM_ENUM(tx_wsa_mux1, LPASS_CDC_TX_INP_MUX_ADC_MUX1_CFG1,
		   4, tx_wsa_mux_text);
LPASS_CDC_TX_MACRO_DAPM_ENUM(tx_wsa_mux2, LPASS_CDC_TX_INP_MUX_ADC_MUX2_CFG1,
		   4, tx_wsa_mux_text);
LPASS_CDC_TX_MACRO_DAPM_ENUM(tx_wsa_mux3, LPASS_CDC_TX_INP_MUX_ADC_MUX3_CFG1,
		   4, tx_wsa_mux_text);
LPASS_CDC_TX_MACRO_DAPM_ENUM(tx_wsa_mux4, LPASS_CDC_TX_INP_MUX_ADC_MUX4_CFG1,
		   4, tx_wsa_mux_text);
LPASS_CDC_TX_MACRO_DAPM_ENUM(tx_wsa_mux5, LPASS_CDC_TX_INP_MUX_ADC_MUX5_CFG1,
		   4, tx_wsa_mux_text);
LPASS_CDC_TX_MACRO_DAPM_ENUM(tx_wsa_mux6, LPASS_CDC_TX_INP_MUX_ADC_MUX6_CFG1,
		   4, tx_wsa_mux_text);
LPASS_CDC_TX_MACRO_DAPM_ENUM(tx_wsa_mux7, LPASS_CDC_TX_INP_MUX_ADC_MUX7_CFG1,
		   4, tx_wsa_mux_text);
#endif
...
LPASS_CDC_TX_MACRO_DAPM_ENUM(tx_psel_mux0, LPASS_CDC_TX_INP_MUX_ADC_MUX0_CFG2,
			0, psel_mux_text);
LPASS_CDC_TX_MACRO_DAPM_ENUM(tx_psel_mux1, LPASS_CDC_TX_INP_MUX_ADC_MUX1_CFG2,
			0, psel_mux_text);
LPASS_CDC_TX_MACRO_DAPM_ENUM(tx_psel_mux2, LPASS_CDC_TX_INP_MUX_ADC_MUX2_CFG2,
			0, psel_mux_text);
LPASS_CDC_TX_MACRO_DAPM_ENUM(tx_psel_mux3, LPASS_CDC_TX_INP_MUX_ADC_MUX3_CFG2,
			0, psel_mux_text);
LPASS_CDC_TX_MACRO_DAPM_ENUM(tx_psel_mux4, LPASS_CDC_TX_INP_MUX_ADC_MUX4_CFG2,
			0, psel_mux_text);
LPASS_CDC_TX_MACRO_DAPM_ENUM(tx_psel_mux5, LPASS_CDC_TX_INP_MUX_ADC_MUX5_CFG2,
			0, psel_mux_text);
LPASS_CDC_TX_MACRO_DAPM_ENUM(tx_psel_mux6, LPASS_CDC_TX_INP_MUX_ADC_MUX6_CFG2,
			0, psel_mux_text);
LPASS_CDC_TX_MACRO_DAPM_ENUM(tx_psel_mux7, LPASS_CDC_TX_INP_MUX_ADC_MUX7_CFG2,
			0, psel_mux_text);
#endif
...
#ifdef CONFIG_BOLERO_VER_4P0
	LPASS_CDC_TX_MACRO_DAPM_MUX("TX WSA MUX0", 0, tx_wsa_mux0),
	LPASS_CDC_TX_MACRO_DAPM_MUX("TX WSA MUX1", 0, tx_wsa_mux1),
	LPASS_CDC_TX_MACRO_DAPM_MUX("TX WSA MUX2", 0, tx_wsa_mux2),
	LPASS_CDC_TX_MACRO_DAPM_MUX("TX WSA MUX3", 0, tx_wsa_mux3),
	LPASS_CDC_TX_MACRO_DAPM_MUX("TX WSA MUX4", 0, tx_wsa_mux4),
	LPASS_CDC_TX_MACRO_DAPM_MUX("TX WSA MUX5", 0, tx_wsa_mux5),
	LPASS_CDC_TX_MACRO_DAPM_MUX("TX WSA MUX6", 0, tx_wsa_mux6),
	LPASS_CDC_TX_MACRO_DAPM_MUX("TX WSA MUX7", 0, tx_wsa_mux7),

	LPASS_CDC_TX_MACRO_DAPM_MUX("TX PORT SEL MUX0", 0, tx_psel_mux0),
	LPASS_CDC_TX_MACRO_DAPM_MUX("TX PORT SEL MUX1", 0, tx_psel_mux1),
	LPASS_CDC_TX_MACRO_DAPM_MUX("TX PORT SEL MUX2", 0, tx_psel_mux2),
	LPASS_CDC_TX_MACRO_DAPM_MUX("TX PORT SEL MUX3", 0, tx_psel_mux3),
	LPASS_CDC_TX_MACRO_DAPM_MUX("TX PORT SEL MUX4", 0, tx_psel_mux4),
	LPASS_CDC_TX_MACRO_DAPM_MUX("TX PORT SEL MUX5", 0, tx_psel_mux5),
	LPASS_CDC_TX_MACRO_DAPM_MUX("TX PORT SEL MUX6", 0, tx_psel_mux6),
	LPASS_CDC_TX_MACRO_DAPM_MUX("TX PORT SEL MUX7", 0, tx_psel_mux7),
#endif
...
static const struct snd_kcontrol_new lpass_cdc_tx_macro_snd_controls[] = {
	...
	SOC_SINGLE_EXT("DEC_GAIN_BYPASS Enable", SND_SOC_NOPM, 0, 1, 0,
