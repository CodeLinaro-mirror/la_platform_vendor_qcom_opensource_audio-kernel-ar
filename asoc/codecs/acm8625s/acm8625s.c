...
/*
 * Driver for the ACM8625S Audio Amplifier
 *
...
static const uint8_t dsp_cfg_preboot[] = {
	...
	0xfe, 0x15, 0x00, 0x01, 0x02, 0x20, 0x00, 0x00,
...
static const uint8_t dsp_cfg_default[] = {
	...
	0x20, 0xff, 0x21, 0x80, 0x22, 0x00, 0x23, 0x00,
	0x24, 0x00, 0x25, 0x00, 0x26, 0x00, 0x27, 0x00,
	0x28, 0x00, 0x29, 0x00, 0x2a, 0x00, 0x2b, 0x00,
	0x2c, 0xff, 0x2d, 0x80, 0x2e, 0x00, 0x2f, 0x00,
	0x00, 0x06, 0xb0, 0x08, 0xb1, 0x00, 0xb2, 0x00,
	...
	0xcb, 0x00, 0xcc, 0x00, 0xcd, 0x00, 0xce, 0x00,
	0xcf, 0x00, 0xd0, 0x00, 0xd1, 0x00, 0xd2, 0x00,
	0xd3, 0x00, 0xd4, 0x00, 0xd5, 0x00, 0xd6, 0x00,
	0xd7, 0x00, 0xd8, 0x08, 0xd9, 0x00, 0xda, 0x00,
	...
	0xeb, 0x00, 0xec, 0x08, 0xed, 0x00, 0xee, 0x00,
	...
	0xff, 0x00, 0x00, 0x07, 0x04, 0x08, 0x05, 0x00,
	...
	0x16, 0x00, 0x17, 0x00, 0x18, 0x08, 0x19, 0x00,
	...
	0x2a, 0x00, 0x2b, 0x00, 0x2c, 0x08, 0x2d, 0x00,
	...
	0x3e, 0x00, 0x3f, 0x00, 0x40, 0x08, 0x41, 0x00,
	...
	0x52, 0x00, 0x53, 0x00, 0x54, 0x08, 0x55, 0x00,
	...
	0x66, 0x00, 0x67, 0x00, 0x68, 0x08, 0x69, 0x00,
	0x6a, 0x00, 0x6b, 0x00, 0x6c, 0x00, 0x6d, 0x00,
	0x6e, 0x00, 0x6f, 0x00, 0x70, 0x00, 0x71, 0x00,
	0x72, 0x00, 0x73, 0x00, 0x74, 0x00, 0x75, 0x00,
	0x76, 0x00, 0x77, 0x00, 0x78, 0x00, 0x79, 0x00,
	0x7a, 0x00, 0x7b, 0x00, 0x7c, 0x08, 0x7d, 0x00,
	0x7e, 0x00, 0x7f, 0x00, 0x80, 0x00, 0x81, 0x00,
	0x82, 0x00, 0x83, 0x00, 0x84, 0x00, 0x85, 0x00,
	0x86, 0x00, 0x87, 0x00, 0x88, 0x00, 0x89, 0x00,
	0x8a, 0x00, 0x8b, 0x00, 0x8c, 0x00, 0x8d, 0x00,
	0x8e, 0x00, 0x8f, 0x00, 0x90, 0x08, 0x91, 0x00,
	...
	0xa2, 0x00, 0xa3, 0x00, 0xa4, 0x08, 0xa5, 0x00,
	...
	0xb6, 0x00, 0xb7, 0x00, 0xb8, 0x08, 0xb9, 0x00,
	...
	,
	...
	0x1d, 0x00, 0x1e, 0x00, 0x1f, 0x00, 0x20, 0x08,
	...
	0x31, 0x00, 0x32, 0x00, 0x33, 0x00, 0x34, 0x08,
	...
	0x45, 0x00, 0x46, 0x00, 0x47, 0x00, 0x48, 0x08,
	...
	0x59, 0x00, 0x5a, 0x00, 0x5b, 0x00, 0x5c, 0x08,
	...
	0x6d, 0x00, 0x6e, 0x00, 0x6f, 0x00, 0x70, 0x08,
	...
	0x81, 0x00, 0x82, 0x00, 0x83, 0x00, 0x84, 0x08,
	...
	0x95, 0x00, 0x96, 0x00, 0x97, 0x00, 0x98, 0x08,
	...
	0xa9, 0x00, 0xaa, 0x00, 0xab, 0x00, 0xac, 0x08,
	...
	0xbd, 0x00, 0xbe, 0x00, 0xbf, 0x00, 0xc0, 0x08,
	...
	0xd1, 0x00, 0xd2, 0x00, 0xd3, 0x00, 0xd4, 0x08,
	...
	0xe5, 0x00, 0xe6, 0x00, 0xe7, 0x00, 0xe8, 0x08,
	...
	0xf9, 0x00, 0xfa, 0x00, 0xfb, 0x00, 0xfc, 0x08,
	0xfd, 0x00, 0xfe, 0x00, 0xff, 0x00, 0x00, 0x09,
	0x04, 0x00, 0x05, 0x00, 0x06, 0x00, 0x07, 0x00,
	0x08, 0x00, 0x09, 0x00, 0x0a, 0x00, 0x0b, 0x00,
	0x0c, 0x00, 0x0d, 0x00, 0x0e, 0x00, 0x0f, 0x00,
	0x10, 0x00, 0x11, 0x00, 0x12, 0x00, 0x13, 0x00,
	0x00, 0x04, 0x88, 0x00, 0x89, 0xe2, 0x8a, 0xc4,
	0x8b, 0x6b, 0x00, 0x01, 0x01, 0x03, 0x00, 0x00,
	0x11, 0x0b, 0x02, 0x06, 0x06, 0x30, 0x28, 0x00,
	0x05, 0xc6, 0x03, 0x02, 0x01, 0x84, 0x00, 0x00,
	0x04, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x04, 0x03,
};
...
#define ACM8625S_VOLUME_MINUS_20DB	90
...
{
	uint8_t v[4];
	uint32_t x = acm8625s_volume[vol];
	int i;
...
static void acm8625s_refresh(struct acm8625s_priv *acm8625s)
{
	...
	set_dsp_scale(rm, 0x7c, acm8625s->vol[0]);
	set_dsp_scale(rm, 0x80, acm8625s->vol[1]);

	regmap_write(rm, REG_PAGE, 0x00);

	if (acm8625s->is_muted || acm8625s->vol[0] == 0) {
			     ...
			     struct snd_ctl_elem_info *uinfo)
{
	...
	uinfo->value.integer.min = ACM8625S_VOLUME_MIN;
	uinfo->value.integer.max = ACM8625S_VOLUME_MAX;
	return 0;
}

static int acm8625s_vol_get(struct snd_kcontrol *kcontrol,
			    struct snd_ctl_elem_value *ucontrol)
{
	...
	ucontrol->value.integer.value[0] = acm8625s->vol[0];
	ucontrol->value.integer.value[1] = acm8625s->vol[1];
...
{
	return (v >= ACM8625S_VOLUME_MIN) && (v <= ACM8625S_VOLUME_MAX);
}

static int acm8625s_vol_put(struct snd_kcontrol *kcontrol,
			    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *component =
		snd_soc_kcontrol_component(kcontrol);
	...
	mutex_lock(&acm8625s->lock);
	if (acm8625s->vol[0] != ucontrol->value.integer.value[0] ||
...
static const struct snd_kcontrol_new acm8625s_snd_controls[] = {
	{
		.iface	= SNDRV_CTL_ELEM_IFACE_MIXER,
		.name	= "Master Playback Volume",
		.access	= SNDRV_CTL_ELEM_ACCESS_TLV_READ |
			  SNDRV_CTL_ELEM_ACCESS_READWRITE,
		.info	= acm8625s_vol_info,
		.get	= acm8625s_vol_get,
		.put	= acm8625s_vol_put,
	},
};
...
static void do_work(struct work_struct *work)
{
	...
	mutex_lock(&acm8625s->lock);
	if (acm8625s->is_powered) {
		dev_dbg(&acm8625s->i2c->dev,
			"DSP startup skipped: already powered\n");
		mutex_unlock(&acm8625s->lock);
		return;
	}
	...
	if (acm8625s->dsp_cfg_data) {
		dev_dbg(&acm8625s->i2c->dev, "DSP startup: use firmware cfg\n");
		send_cfg(rm, acm8625s->dsp_cfg_data, acm8625s->dsp_cfg_len);
	} else {
		dev_dbg(&acm8625s->i2c->dev, "DSP startup: use default cfg\n");
			      ...
			      struct snd_kcontrol *kcontrol, int event)
{
	...
	if (event & SND_SOC_DAPM_POST_PMU) {
		dev_dbg(component->dev, "dac POST_PMU startup request\n");
		schedule_work(&acm8625s->work);
		flush_work(&acm8625s->work);
	}
...
static const struct snd_soc_dapm_widget acm8625s_dapm_widgets[] = {
	...
	SND_SOC_DAPM_DAC_E("DAC", NULL, SND_SOC_NOPM, 0, 0,
		acm8625s_dac_event, SND_SOC_DAPM_POST_PMU | SND_SOC_DAPM_PRE_PMD),
...
static int acm8625s_prepare(struct snd_pcm_substream *substream,
				  struct snd_soc_dai *dai)
{
	struct snd_soc_component *component = dai->component;
	struct acm8625s_priv *acm8625s =
	...
	if (substream->stream == SNDRV_PCM_STREAM_PLAYBACK &&
	    !acm8625s->is_powered) {
		dev_dbg(component->dev, "prepare: force startup fallback\n");
		schedule_work(&acm8625s->work);
		flush_work(&acm8625s->work);
	}
...
static int acm8625s_mute(struct snd_soc_dai *dai, int mute, int direction)
{
	struct snd_soc_component *component = dai->component;
	struct acm8625s_priv *acm8625s =
		snd_soc_component_get_drvdata(component);
...
static const struct regmap_config acm8625s_regmap = {
	.reg_bits	= 8,
	.val_bits	= 8,
...
static int acm8625s_i2c_probe(struct i2c_client *i2c)
{
	...
	acm8625s = devm_kzalloc(dev, sizeof(struct acm8625s_priv), GFP_KERNEL);
	if (!acm8625s)
		return -ENOMEM;

	acm8625s->power_gpio = of_get_named_gpio(i2c->dev.of_node, "power-gpio", 0);
	if (gpio_is_valid(acm8625s->power_gpio)) {
		ret = devm_gpio_request_one(dev, acm8625s->power_gpio,
			GPIOF_OUT_INIT_HIGH, "acm8625s_power");
		if (ret) {
			dev_err(dev, "power request failed\n");
			return ret;
		} else
			dev_dbg(dev, "power init high success\n");
	}
	 ...
	 */
	ret = snd_soc_register_component(dev, &soc_codec_dev_acm8625s,
					 &acm8625s_dai, 1);
	if (ret < 0) {
...
static const struct i2c_device_id acm8625s_i2c_id[] = {
	{ "acm8625s", },
	{ }
};
MODULE_DEVICE_TABLE(i2c, acm8625s_i2c_id);
...
static struct i2c_driver acm8625s_i2c_driver = {
	.probe  	= acm8625s_i2c_probe,
	.remove		= acm8625s_i2c_remove,
	.id_table	= acm8625s_i2c_id,
	.driver		= {
		.name		= "acm8625s",
...
module_i2c_driver(acm8625s_i2c_driver);

MODULE_AUTHOR("Wenhao Yang <wenhaoy@acme-semi.com>");
MODULE_DESCRIPTION("ACM8625S Audio Amplifier Driver");
