...
#define QAIF_REG_ADDR(v, offset)						(offset)
/* Base for AUDIO_CORE_QAIF_HW_VERSION 0xA000000 */

#define QAIF_SUMMARY_IRQSTAT_REG(v) 					(0x19188 + (0x1000 * (v->ee)))			 /* 0xA019188 */
/*
#define QAIF_RDDMA_UNDERFLOW_REG(v) 		QAIF_REG_ADDR(v, 0x19188 + (0x1000 * (ee)))
*/

/* Shikra core registers */

/* Core HW info */
#define QAIF_HW_VERSION_REG(v)                              (0x0000)  /* 0xA000000 */
...
#define QAIF_CODEC_TX_INTF_CH_INFO_REG(n)                   (0x0028 + (0x4 * (n))) /* 0xA000028 .. 0xA000044 (n:0..7) */
#define QAIF_CODEC_RX_INTF_CH_INFO_REG(n)                   (0x0068 + (0x4 * (n))) /* 0xA000068 .. 0xA000084 (n:0..7) */
...
#define QAIF_EE_RDDMA_ASSIGNMENT_REG(v)                     (0x19148 + (0x1000 * (v->ee))) /* 0xA019148 */
#define QAIF_EE_WRDMA_ASSIGNMENT_REG(v)                     (0x19150 + (0x1000 * (v->ee))) /* 0xA019150 */
#define QAIF_EE_INTF_ASSIGNMENT_REG(v)                      (0x19158 + (0x1000 * (v->ee))) /* 0xA019158 */
#define QAIF_EE_CODEC_RDDMA_ASSIGNMENT_REG(v)               (0x19308 + (0x1000 * (v->ee))) /* 0xA019308 */
#define QAIF_EE_CODEC_WRDMA_ASSIGNMENT_REG(v)               (0x19318 + (0x1000 * (v->ee))) /* 0xA019318 */
#define QAIF_EE_RDDMA_MAP_REG(v)                            (0x1920 + (0x1000 * (v->ee)))  /* 0xA001920 */
#define QAIF_EE_WRDMA_MAP_REG(v)                            (0x1940 + (0x1000 * (v->ee)))  /* 0xA001940 */
#define QAIF_EE_INTF_MAP_REG(v)                             (0x1960 + (0x1000 * (v->ee)))  /* 0xA001960 */
#define QAIF_EE_CODEC_RDDMA_MAP_REG(v)                      (0x1980 + (0x1000 * (v->ee)))  /* 0xA001980 */
#define QAIF_EE_CODEC_WRDMA_MAP_REG(v)                      (0x1A00 + (0x1000 * (v->ee)))  /* 0xA001A00 */

/* EE rate-detection and VFR interrupts */
#define QAIF_EE_RATE_DET_IRQ_EN_REG(v)                      (0x190F0 + (0x1000 * (v->ee))) /* 0xA0190F0 */
#define QAIF_EE_RATE_DET_IRQ_STATUS_REG(v)                  (0x190F4 + (0x1000 * (v->ee))) /* 0xA0190F4 */
#define QAIF_EE_RATE_DET_IRQ_RAW_STATUS_REG(v)              (0x190F8 + (0x1000 * (v->ee))) /* 0xA0190F8 */
#define QAIF_EE_RATE_DET_IRQ_CLEAR_REG(v)                   (0x190FC + (0x1000 * (v->ee))) /* 0xA0190FC */
#define QAIF_EE_RATE_DET_IRQ_FORCE_REG(v)                   (0x19100 + (0x1000 * (v->ee))) /* 0xA019100 */

#define QAIF_EE_VFR_IRQ_EN_REG(v)                           (0x19104 + (0x1000 * (v->ee))) /* 0xA019104 */
#define QAIF_EE_VFR_IRQ_STATUS_REG(v)                       (0x19108 + (0x1000 * (v->ee))) /* 0xA019108 */
#define QAIF_EE_VFR_IRQ_RAW_STATUS_REG(v)                   (0x1910C + (0x1000 * (v->ee))) /* 0xA01910C */
#define QAIF_EE_VFR_IRQ_CLEAR_REG(v)                        (0x19110 + (0x1000 * (v->ee))) /* 0xA019110 */
#define QAIF_EE_VFR_IRQ_FORCE_REG(v)                        (0x19114 + (0x1000 * (v->ee))) /* 0xA019114 */

/* EE AUD_INTF underflow/overflow interrupts */
#define QAIF_EE_AUD_INTF_UNDERFLOW_IRQ_EN_REG(v)            (0x19160 + (0x1000 * (v->ee))) /* 0xA019160 */
#define QAIF_EE_AUD_INTF_UNDERFLOW_IRQ_STATUS_REG(v)        (0x19164 + (0x1000 * (v->ee))) /* 0xA019164 */
#define QAIF_EE_AUD_INTF_UNDERFLOW_IRQ_RAW_STATUS_REG(v)    (0x19168 + (0x1000 * (v->ee))) /* 0xA019168 */
#define QAIF_EE_AUD_INTF_UNDERFLOW_IRQ_CLEAR_REG(v)         (0x1916C + (0x1000 * (v->ee))) /* 0xA01916C */
#define QAIF_EE_AUD_INTF_UNDERFLOW_IRQ_FORCE_REG(v)         (0x19170 + (0x1000 * (v->ee))) /* 0xA019170 */

#define QAIF_EE_AUD_INTF_OVERFLOW_IRQ_EN_REG(v)             (0x19174 + (0x1000 * (v->ee))) /* 0xA019174 */
#define QAIF_EE_AUD_INTF_OVERFLOW_IRQ_STATUS_REG(v)         (0x19178 + (0x1000 * (v->ee))) /* 0xA019178 */
#define QAIF_EE_AUD_INTF_OVERFLOW_IRQ_RAW_STATUS_REG(v)     (0x1917C + (0x1000 * (v->ee))) /* 0xA01917C */
#define QAIF_EE_AUD_INTF_OVERFLOW_IRQ_CLEAR_REG(v)          (0x19180 + (0x1000 * (v->ee))) /* 0xA019180 */
#define QAIF_EE_AUD_INTF_OVERFLOW_IRQ_FORCE_REG(v)          (0x19184 + (0x1000 * (v->ee))) /* 0xA019184 */

/* EE L2 Period IRQ mux selection */
#define QAIF_EE_L2_PERIOD_IRQ_0_3_MUX_SEL_REG(v)            (0x19F00 + (0x1000 * (v->ee))) /* 0xA019F00 */
#define QAIF_EE_L2_PERIOD_IRQ_4_7_MUX_SEL_REG(v)            (0x19F04 + (0x1000 * (v->ee))) /* 0xA019F04 */
...
#define QAIF_AUD_INTF_CTL_REG(intf)                          QAIF_AUD_INTF_REG_ADDR(0x0000, (intf)) /* 0xA004000 */
#define QAIF_AUD_INTF_SYNC_CFG_REG(intf)                     QAIF_AUD_INTF_REG_ADDR(0x0004, (intf)) /* 0xA004004 */
#define QAIF_AUD_INTF_BIT_WIDTH_CFG_REG(intf)                QAIF_AUD_INTF_REG_ADDR(0x0008, (intf)) /* 0xA004008 */
#define QAIF_AUD_INTF_FRAME_CFG_REG(intf)                    QAIF_AUD_INTF_REG_ADDR(0x000C, (intf)) /* 0xA00400C */
#define QAIF_AUD_INTF_ACTV_SLOT_EN_TX_REG(intf)              QAIF_AUD_INTF_REG_ADDR(0x0010, (intf)) /* 0xA004010 */
#define QAIF_AUD_INTF_ACTV_SLOT_EN_RX_REG(intf)              QAIF_AUD_INTF_REG_ADDR(0x0030, (intf)) /* 0xA004030 */
#define QAIF_AUD_INTF_LANE_CFG_REG(intf)                     QAIF_AUD_INTF_REG_ADDR(0x0050, (intf)) /* 0xA004050 */
#define QAIF_AUD_INTF_MI2S_CFG_REG(intf)                     QAIF_AUD_INTF_REG_ADDR(0x0054, (intf)) /* 0xA004054 */
#define QAIF_AUD_INTF_CFG_REG(intf)                          QAIF_AUD_INTF_REG_ADDR(0x0058, (intf)) /* 0xA004058 */
#define QAIF_AUD_INTF_CHAR_CTL_REG(intf)                     QAIF_AUD_INTF_REG_ADDR(0x005C, (intf)) /* 0xA00405C */
#define QAIF_AUD_INTF_CHAR_CFG_REG(intf)                     QAIF_AUD_INTF_REG_ADDR(0x0060, (intf)) /* 0xA004060 */
#define QAIF_AUD_INTF_CHAR_DATA_REG(intf)                    QAIF_AUD_INTF_REG_ADDR(0x0064, (intf)) /* 0xA004064 */
#define QAIF_AUD_INTF_CHAR_DATA_EXT_REG(intf)                QAIF_AUD_INTF_REG_ADDR(0x0068, (intf)) /* 0xA004068 */
#define QAIF_AUD_INTF_CHAR_SYNC_REG(intf)                    QAIF_AUD_INTF_REG_ADDR(0x006C, (intf)) /* 0xA00406C */
#define QAIF_AUD_INTF_INIT_DBG_STATUS_REG(intf)              QAIF_AUD_INTF_REG_ADDR(0x0FF0, (intf)) /* 0xA004FF0 */
#define QAIF_AUD_INTF_TX_DBG_STATUS_REG(intf)                QAIF_AUD_INTF_REG_ADDR(0x0FF4, (intf)) /* 0xA004FF4 */
#define QAIF_AUD_INTF_RX_DBG_STATUS_REG(intf)                QAIF_AUD_INTF_REG_ADDR(0x0FF8, (intf)) /* 0xA004FF8 */
...
#define QAIF_RATE_DET_CONFIG_REG(det)                        QAIF_RATE_DET_REG_ADDR(0x0000, (det)) /* 0xA01E000 */
#define QAIF_RATE_DET_TARGET1_CONFIG_REG(det)                QAIF_RATE_DET_REG_ADDR(0x0004, (det)) /* 0xA01E004 */
#define QAIF_RATE_DET_TARGET2_CONFIG_REG(det)                QAIF_RATE_DET_REG_ADDR(0x0008, (det)) /* 0xA01E008 */
#define QAIF_RATE_DET_BIN_REG(det)                           QAIF_RATE_DET_REG_ADDR(0x000C, (det)) /* 0xA01E00C */
#define QAIF_RATE_DET_STC_DIFF_REG(det)                      QAIF_RATE_DET_REG_ADDR(0x0010, (det)) /* 0xA01E010 */
#define QAIF_RATE_DET_SEL_REG(det)                           QAIF_RATE_DET_REG_ADDR(0x0014, (det)) /* 0xA01E014 */
#define QAIF_RATE_DET_TIMEOUT_CFG_REG(det)                   QAIF_RATE_DET_REG_ADDR(0x0018, (det)) /* 0xA01E018 */
...
*/
#define QAIF_RDDMA_REG_ADDR(v, offset, chan) 				(v->rddma_reg_base + (offset) + v->rddma_stride * (chan))
...
#define QAIF_CODEC_RDDMA_REG_ADDR(v, offset, chan) 			(v->codec_rddma_reg_base + (offset) + v->codec_rddma_stride * (chan))
...
/*
	...
	v : ptr to qaif_variant
*/
#define QAIF_WRDMA_REG_ADDR(v, offset, chan) 				(v->wrdma_reg_base + (offset) + v->wrdma_stride * (chan))
...
#define QAIF_CODEC_WRDMA_REG_ADDR(v, offset, chan) 			(v->codec_wrdma_reg_base + (offset) + v->codec_wrdma_stride * (chan))
