...
SND_SOC_DAILINK_DEFS(tx_dma_tx0,
	DAILINK_COMP_ARRAY(COMP_CPU("snd-soc-dummy-dai")),
	DAILINK_COMP_ARRAY(COMP_CODEC("lpass-cdc", "tx_macro_tx3")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("snd-soc-dummy")));
...
SND_SOC_DAILINK_DEFS(quin_tdm_wsa885x_i2c_rx,
	DAILINK_COMP_ARRAY(COMP_CPU("snd-soc-dummy-dai")),
	DAILINK_COMP_ARRAY(COMP_CODEC("wsa885x_i2c", "wsa885x_dai_drv")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("snd-soc-dummy")));

SND_SOC_DAILINK_DEFS(quin_tdm_wsa885x_i2c_tx,
	DAILINK_COMP_ARRAY(COMP_CPU("snd-soc-dummy-dai")),
	DAILINK_COMP_ARRAY(COMP_DUMMY()),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("snd-soc-dummy")));

SND_SOC_DAILINK_DEFS(sen_tdm_wsa885x_i2c_rx,
	DAILINK_COMP_ARRAY(COMP_CPU("snd-soc-dummy-dai")),
	DAILINK_COMP_ARRAY(COMP_CODEC("wsa885x_i2c", "wsa885x_dai_drv")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("snd-soc-dummy")));

SND_SOC_DAILINK_DEFS(sen_tdm_wsa885x_i2c_tx,
	DAILINK_COMP_ARRAY(COMP_CPU("snd-soc-dummy-dai")),
	DAILINK_COMP_ARRAY(COMP_DUMMY()),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("snd-soc-dummy")));
...
// QAIF CPU DAILINK DEFINITION
SND_SOC_DAILINK_DEFS(rx_qaif_dma_rx0,
	DAILINK_COMP_ARRAY(COMP_CPU("CDC DMA RX0")),
	DAILINK_COMP_ARRAY(COMP_CODEC("lpass-cdc", "rx_macro_rx1")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("a000000.audio")));

SND_SOC_DAILINK_DEFS(rx_qaif_dma_rx1,
	DAILINK_COMP_ARRAY(COMP_CPU("CDC DMA RX1")),
	DAILINK_COMP_ARRAY(COMP_CODEC("lpass-cdc", "rx_macro_rx2"),
						COMP_CODEC("rouleur-codec", "rouleur_cdc")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("a000000.audio")));

SND_SOC_DAILINK_DEFS(va_qaif_dma_tx0,
	DAILINK_COMP_ARRAY(COMP_CPU("CDC DMA VA0")),
	DAILINK_COMP_ARRAY(COMP_CODEC("lpass-cdc", "va_macro_tx1"),
						COMP_CODEC("rouleur-codec", "rouleur_cdc")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("a000000.audio")));

SND_SOC_DAILINK_DEFS(quin_qaif_mi2s_rx,
	DAILINK_COMP_ARRAY(COMP_CPU("Quinary MI2S")),
	DAILINK_COMP_ARRAY(COMP_CODEC("msm-stub-codec.1", "msm-stub-rx")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("a000000.audio")));

SND_SOC_DAILINK_DEFS(quin_qaif_mi2s_tx,
	DAILINK_COMP_ARRAY(COMP_CPU("Quinary MI2S")),
	DAILINK_COMP_ARRAY(COMP_CODEC("msm-stub-codec.1", "msm-stub-tx")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("a000000.audio")));

SND_SOC_DAILINK_DEFS(sen_qaif_mi2s_rx,
	DAILINK_COMP_ARRAY(COMP_CPU("Senary MI2S")),
	DAILINK_COMP_ARRAY(COMP_CODEC("msm-stub-codec.1", "msm-stub-rx")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("a000000.audio")));

SND_SOC_DAILINK_DEFS(sen_qaif_mi2s_tx,
	DAILINK_COMP_ARRAY(COMP_CPU("Senary MI2S")),
	DAILINK_COMP_ARRAY(COMP_CODEC("msm-stub-codec.1", "msm-stub-tx")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("a000000.audio")));
...
SND_SOC_DAILINK_DEFS(sen_tdm_qaif_tx_0,
	DAILINK_COMP_ARRAY(COMP_CPU("Senary MI2S")),
	DAILINK_COMP_ARRAY(COMP_CODEC("msm-stub-codec.1", "msm-stub-tx")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("a000000.audio")));

SND_SOC_DAILINK_DEFS(quin_tdm_qaif_wsa885x_i2c_rx,
	DAILINK_COMP_ARRAY(COMP_CPU("Quinary MI2S")),
	DAILINK_COMP_ARRAY(COMP_CODEC("wsa885x_i2c", "wsa885x_dai_drv")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("a000000.audio")));

SND_SOC_DAILINK_DEFS(quin_tdm_qaif_wsa885x_i2c_tx,
	DAILINK_COMP_ARRAY(COMP_CPU("Quinary MI2S")),
	DAILINK_COMP_ARRAY(COMP_DUMMY()),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("a000000.audio")));

SND_SOC_DAILINK_DEFS(sen_tdm_qaif_wsa885x_i2c_rx,
	DAILINK_COMP_ARRAY(COMP_CPU("Senary MI2S")),
	DAILINK_COMP_ARRAY(COMP_CODEC("wsa885x_i2c", "wsa885x_dai_drv")),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("a000000.audio")));

SND_SOC_DAILINK_DEFS(sen_tdm_qaif_wsa885x_i2c_tx,
	DAILINK_COMP_ARRAY(COMP_CPU("Senary MI2S")),
	DAILINK_COMP_ARRAY(COMP_DUMMY()),
	DAILINK_COMP_ARRAY(COMP_PLATFORM("a000000.audio")));
