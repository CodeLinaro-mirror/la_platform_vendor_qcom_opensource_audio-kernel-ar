...
#define REGISTER_ADDRESS(version_index, register) \
(SWRM_BASE + swrm_registers[register][version_index])
...
#define SWRM_INTERRUPT_STATUS_RD_FIFO_OVERFLOW_VER_1P6_2P0              0x10
#define SWRM_INTERRUPT_STATUS_RD_FIFO_UNDERFLOW_VER_1P6_2P0             0x20
#define SWRM_INTERRUPT_STATUS_SPECIAL_CMD_ID_FINISHED_VER_1P6_2P0       0x400
#define SWRM_INTERRUPT_STATUS_RD_FIFO_OVERFLOW_VER_1P7                  0x40000
#define SWRM_INTERRUPT_STATUS_RD_FIFO_UNDERFLOW_VER_1P7                 0x80000
#define SWRM_INTERRUPT_STATUS_SPECIAL_CMD_ID_FINISHED_VER_1P7           0x100000
