...
ifeq ($(call is-board-platform-in-list,canoe alor whale),true)
...
ifeq ($(call is-board-platform-in-list,taro kalama bengal pineapple sun holi blair gen4 msmnile canoe alor whale), true)
...
include $(DLKM_DIR)/Build_external_kernelmodule.mk
###########################################################
ifeq ($(call is-board-platform-in-list, sun canoe alor whale),true)
###########################################################
include $(CLEAR_VARS)
LOCAL_SRC_FILES           := $(AUDIO_SRC_FILES)
...
include $(CLEAR_VARS)
LOCAL_SRC_FILES           := $(AUDIO_SRC_FILES)
LOCAL_MODULE              := wsa885x_i2c_dlkm.ko
LOCAL_MODULE_KBUILD_NAME  := asoc/codecs/wsa885x_i2c_dlkm.ko
LOCAL_MODULE_TAGS         := optional
LOCAL_MODULE_DEBUG_ENABLE := true
LOCAL_MODULE_PATH         := $(KERNEL_MODULES_OUT)
include $(DLKM_DIR)/Build_external_kernelmodule.mk
